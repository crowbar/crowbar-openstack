...
neutron_api_extensions = "provider,security-group,dhcp_agent_scheduler,external-net,ext-gw-mode,binding,agent,quotas,l3_agent_scheduler,multi-provider,router,extra_dhcp_opt,allowed-address-pairs,extraroute,metering,fwaas,service-type,project-id,sorting,pagination,port-security,default-subnetpools,fwaasrouterinsertion,standard-attr-revisions,standard-attr-description,flavors,hm_max_retries_down"
