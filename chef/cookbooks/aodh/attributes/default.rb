...
default[:aodh][:ha][:api][:agent] = "service:#{api_service_name}"
default[:aodh][:ha][:api][:op][:monitor][:interval] = "10s"
default[:aodh][:ha][:evaluator][:agent] = "service:#{evaluator_service_name}"
default[:aodh][:ha][:evaluator][:op][:monitor][:interval] = "10s"
default[:aodh][:ha][:notifier][:agent] = "service:#{notifier_service_name}"
default[:aodh][:ha][:notifier][:op][:monitor][:interval] = "10s"
default[:aodh][:ha][:listener][:agent] = "service:#{listener_service_name}"
