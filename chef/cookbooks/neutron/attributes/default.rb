...
default[:neutron][:lbaas_service_file] = "/etc/neutron/neutron.conf.d/110-neutron_service_lbaas.conf"
default[:neutron][:lbaas_config_file] = "/etc/neutron/neutron.conf.d/111-neutron_lbaas.conf"
