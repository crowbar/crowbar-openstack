...
crowbar_pacemaker_sync_mark "sync-manila_share_before_ha"

# Avoid races when creating pacemaker resources
crowbar_pacemaker_sync_mark "wait-manila_share_ha_resources"

transaction_objects = []

service_name = "manila-share"
pacemaker_primitive service_name do
  agent node[:manila][:ha][:share_ra]
...
pacemaker_transaction "manila share" do
...
crowbar_pacemaker_sync_mark "create-manila_share_ha_resources"
