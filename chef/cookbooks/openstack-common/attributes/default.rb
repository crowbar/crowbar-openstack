...
default['openstack']['endpoints']['database_service-guestagent']['host'] = "127.0.0.1"
default['openstack']['endpoints']['database_service-guestagent']['scheme'] = "http"
default['openstack']['endpoints']['database_service-guestagent']['port'] = "8778"
default['openstack']['endpoints']['database_service-guestagent']['path'] = "/v1.0"
default['openstack']['endpoints']['database_service-guestagent']['bind_interface'] = nil
...
default['openstack']['db']['database_service']['db_type'] = node['openstack']['db']['service_type']
default['openstack']['db']['database_service']['host'] = "127.0.0.1"
...
default['openstack']['mq']['database_service']['rabbit']['host'] = 'localhost'
default['openstack']['mq']['database_service']['rabbit']['userid'] = 'guest'
default['openstack']['mq']['database_service']['rabbit']['port'] = '5672'
default['openstack']['mq']['database_service']['rabbit']['vhost'] = '/'
