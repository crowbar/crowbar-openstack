...
attribute :match_pattern, kind_of: String, default: nil
attribute :timeout, kind_of: Integer, default: 10
attribute :collect_response_time, kind_of: [TrueClass, FalseClass], default: true
attribute :use_keystone, kind_of: [TrueClass, FalseClass], default: true
